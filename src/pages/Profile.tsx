...
const Profile = () => {
  ...
  const handleSave = async () => {
    ...
    if (!editableData.drivingLicenseValidityDate) missingFields.push('Driving License Validity Date');
    ...
    if (missingFields.length > 0) {
      setError(`Please fill in all required document fields: ${missingFields.join(', ')}`);
      setSaving(false);
      return;
    }
