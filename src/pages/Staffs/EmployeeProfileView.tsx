...
import { fetchUserRole, isAdmin as checkIsAdmin } from '../../utils/userRole';
...
const EmployeeProfileView = () => {
  ...
  const [_currentUserRole, setCurrentUserRole] = useState<string>('');
  ...
  const fetchEmployeeData = async (id: string, userId: string, userRole: string) => {
    try {
      ...
      const adminUser = checkIsAdmin(userRole);
