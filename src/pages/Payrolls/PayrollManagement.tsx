        ...
        <table className="staff-table">
          ...
          <tbody>
            {filteredPayrolls.length === 0 ? (
              <tr>
                <td colSpan={isAdminUser ? 12 : 11} className="no-data">
              ...
              filteredPayrolls.map((payroll) => (
                <tr key={payroll.id}>
                  ...
                  <td>{formatDate(payroll.month, payroll.year)}</td>
                  <td>{formatCurrency(payroll.baseSalary)}</td>
                  <td>{formatCurrency(payroll.overtimeAmount)} ({payroll.overtimeHours}h)</td>
                  ...
                  <td style={{ fontWeight: 'bold', color: '#059669' }}>{formatCurrency(payroll.netSalary)}</td>
                  <td>
