...
const ProfileCompletion = () => {
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement | HTMLTextAreaElement>) => {
    ...
    if (name === 'dateOfBirth') {
      ...
      const wasMedical = medicalDepts.includes(formData.department);
      const isMedical = medicalDepts.includes(value);
      
      if (wasMedical && !isMedical) {
        // Switching from medical to non-medical, clear medical fields
        setFormData(prev => ({
          ...prev,
          [name]: value,
          medicalDesignation: '',
  ...
  const isMedicalDepartment = (): boolean => {
    const medicalDepts = ['Doctor', 'Nurse', 'Pharmacy'];
    return medicalDepts.includes(formData.department);
  };
  ...
  const isFormValid = (): boolean => {
    ...
    // Medical fields required if medical department
    if (isMedicalDepartment()) {
      return requiredFields.every(field => field) &&
        !!formData.medicalDesignation &&
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!validationResult) {
      ...
      if (!formData.drivingLicenseValidityDate) missingFields.push('Driving License Validity Date');
      ...
      if (isMedicalDepartment()) {
        if (!formData.medicalDesignation) missingFields.push('Medical Designation');
        if (!formData.medicalLicenseNumber) missingFields.push('Medical License Number');
        if (!formData.workplaceName) missingFields.push('Workplace Name');
        if (!formData.licenseValidityDate) missingFields.push('License Validity Date');
      }
    ...
    try {
      ...
      try {
        ...
        if (medicalLicenseImage && isMedicalDepartment()) {
    ...
    <div className="profile-completion-container">
      <div className="profile-completion-card">
        ...
        <form onSubmit={handleSubmit} className="profile-form">
            ...
            <div className="form-grid">
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  required
                />
                <small>Driving License Expiry Date</small>
              </div>
            </div>
          </section>
          ...
          {isMedicalDepartment() && (
            <section className="form-section">
              <h2 className="section-title">Medical Staff Information</h2>
              <div className="form-grid">
                <div className="form-group">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    required={isMedicalDepartment()}
                    placeholder="e.g., General Practitioner, Registered Nurse"
                  />
                </div>
                <div className="form-group">
              ...
              <div className="form-grid">
                <div className="form-group">
                  ...
                  <small>Mandatory - Upload clear image of your Medical License</small>
                </div>
              </div>
            </section>
          )}
